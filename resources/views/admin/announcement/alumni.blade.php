    ...
    <div class="column is-12-mobile is-12-tablet is-12-desktop is-12-widescreen is-12-fullhd" id="jobfair-content">
        <div class="columns is-centered is-mobile">
            <div class="column is-12-mobile is-12-tablet is-11-desktop is-11-widescreen is-11-fullhd">
                <div class="container is-centered is-fluid" id="alumni-container">
                    <header class="table-header">
                        <div class="table-title">
                            <h2>Job Fair's</h2>
                        </div>
                        <div class="table-option" id="alumni-table-options">

                            <form id="alumni-form" autocomplete="off">
                                <div class="columns is-desktop">
                                    <div class="column is-1-desktop" id="add-alumni">
                                        <div class="columns is-desktop">
                                            <div class="column">
                                                <button class="button is-link is-small" id="alumni-add-button">New
                                                    Data</button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="field">
                                            <div class="control">
                                                <div class="select is-small">
                                                    <select id="alumni-search-selected">
                                    ...
                                    <div
                                        ...
                                        <div class="control">
                                            <div class="control has-icons-left has-icons-right">
                                                <input class="input is-small" id="alumni-search" type="text"
                                                    placeholder="Search">
                    ...
                    <div class="table-container">
                        <table class="table is-narrow is-fullwidth is-bordered is-hoverable" id="alumni-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="has-text-centered">JOB DESC.</th>
                                    <th class="has-text-centered">JOB QUAL.</th>
                                    <th class="has-text-centered">JOB POST.</th>
                                    <th class="has-text-centered">JOB AVAIL</th>
                    ...
                    <footer class="table-footer" id="alumni-table-footer">
                        <div class="column is-12" id="pagination-container">
                            <nav class="pagination is-small" role="navigation" aria-label="pagination"
                                id="alumni-pagination">
                                ...
                                <ul class="pagination-list" id="alumni-pagination-list">
                                    <li>
